<template>
  <div class="welcome-container">
    ...
    <div class="welcome-content">
      ...
      <h1 class="welcome-title">Bienvenue sur Khaleen Schools !</h1>
      ...
      <div class="keys-info" v-if="keys">
        <div class="key-item">
          <span class="key-label">Clé Publique :</span>
          <code class="key-value">{{ keys.public_key }}</code>
        </div>
        <div class="key-item">
          <span class="key-label">Clé Secrète :</span>
      ...
      <div class="download-section">
        ...
        >
          <span class="btn-content">
            ...
            <span class="btn-text">
              {{ loading ? 'Redirection...' : 'Téléchargez les fichiers nécessaires pour commencer la gestion' }}
            </span>
      ...
      <div class="next-steps">
        ...
        <ul>
          <li>📚 Configurer les classes et niveaux</li>
          <li>👨‍🏫 Ajouter les enseignants</li>
          <li>🎒 Importer la liste des élèves</li>
...
// Charger les données d'inscription
const loadRegistrationData = () => {
  const registrationData = JSON.parse(localStorage.getItem('registrationData') || '{}')
  
  if (registrationData.data) {
    schoolName.value = registrationData.data.name
    keys.value = registrationData.keys
  } else {
    // Données de démo
    schoolName.value = 'Votre Établissement'
    keys.value = {
      public_key: 'PUB-' + Math.random().toString(36).substr(2, 16).toUpperCase(),
      secret_key: 'SEC-' + Math.random().toString(36).substr(2, 32).toUpperCase()
    }
  }
}
